/*
 * File: FilledRectangle.java
 * --------------------------
 * This file defines a graphical object that appears as a
 * filled rectangle.  
 */
...
/**
 * This class is a GObject subclass that is almost identical to
 * GRect except that it starts out filled instead of outlined. 
 * @author Alexandra
 */
